...
userRouter.post("/signup",
    ...
    validation(Schema.signUpSchema),US.signUp
)
...
userRouter.post("/signIn",validation(Schema.signInSchema), US.signIn);
...
userRouter.patch("/update-profile",authentication, validation(Schema.updateProfileSchema),US.updateProfile);
userRouter.patch("/update-password",authentication, validation(Schema.updatePasswordSchema),US.updatePassword);
...
userRouter.patch("/confirm-email",validation(Schema.confirmEmailSchema),US.confirmEmail);
